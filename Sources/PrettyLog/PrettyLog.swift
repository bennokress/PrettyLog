...
public func logV(_ messages: String?..., joinedBy separator: String = " - ", category: LogCategory = .uncategorized, _ data: [String: Any]? = nil) {
...
/// - Attention: No log will be created, if `messages` is empty or only contains `nil`.
public func logD(_ messages: String?..., joinedBy separator: String = " - ", category: LogCategory = .uncategorized, _ data: [String: Any]? = nil) {
    guard let message = String.joined(from: messages, using: separator) else { return }
...
/// - Attention: No log will be created, if `messages` is empty or only contains `nil`.
public func logI(_ messages: String?..., joinedBy separator: String = " - ", category: LogCategory = .uncategorized, _ data: [String: Any]? = nil) {
    guard let message = String.joined(from: messages, using: separator) else { return }
...
/// - Attention: No log will be created, if `messages` is empty or only contains `nil`.
public func logW(_ messages: String?..., joinedBy separator: String = " - ", category: LogCategory = .uncategorized, _ data: [String: Any]? = nil) {
    guard let message = String.joined(from: messages, using: separator) else { return }
...
/// - Attention: No log will be created, if `messages` is empty or only contains `nil`.
public func logE(_ messages: String?..., joinedBy separator: String = " - ", category: LogCategory = .uncategorized, _ data: [String: Any]? = nil) {
    guard let message = String.joined(from: messages, using: separator) else { return }
